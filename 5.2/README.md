...
- * предложите SCADA систему подходящую для использования на объектах в домашнем задании, аргументируйте свой выбор в чеклисте
...
6. * предложена SCADA система подходящая для использования на объектах в домашнем задании, аргументирован выбор SCADA системы.
