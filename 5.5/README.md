...
На сегодняшний день возрастает роль ОС Linux во многих компаниях Особенно актуальной переход на данную ОС становится в следствии импортозамещения в промышленности. Поэтому, знание основ Linux и умение работать в консоли будут становится всё более востребованными каждый год. В этой домашнеф работы мы начнём знакомство с этим семействои операционных систем.
