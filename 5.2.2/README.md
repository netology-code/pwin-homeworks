...
6. Любые вопросы по решению задач задавайте в [чате поддержки](https://netology.ru/profile?modal=support&type=new-ticket) или в разделе «Вопросы по заданию» при выполнении практических заданий.
...
Изучите документацию [Microsoft](https://support.microsoft.com/ru-ru/windows). Пройдите обучение, используйте сайт как базу знаний по Windows. Это упражнение развивает навык использования документации, что поможет на старте работы на специфичном производстве.
